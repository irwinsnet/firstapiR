...
This package contains two other vignettes:

1. _More firstapiR Functions_ provides guidance and examples on a few of the 
trickier firstapiR functions.
1. _Analyzing FIRST API Data_ provides a few examples of how data provided by
firstapiR functions can be manipulated and exported in R.
